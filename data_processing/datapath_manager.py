...
def get_feature_path(ds_path_manager: DatasetPath, user_id: str, signal_type: str, window_size: float, window_shift: float):
    """
                ...
                |__ user_id
                    |__ features
                        |__ {window_size}_{window_shift}
                            |__ {signal_type}.npy
    """
    folder_path = os.path.join(ds_path_manager.user_data_paths[user_id].feature_path, f'{window_size}_{window_shift}')
...
def get_datapath_manager(dataset_name: str):
    ...
    ds_path_manager = DatasetPath(
        ...
        combined_stats_feature_path=os.path.join(dataset_path, f'combined_stats_features'),
